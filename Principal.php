...
/*
  El Array $Valor contiene las cadenas de texto que pueden imprimirse.
...
for ( $Numero = 1; $Numero < 101; $Numero ++ ) {
  ...
  // La variable $IndiceValor contiene un valor del indice que podría cambiar si el número actual
  ...
  foreach ( $Multiplos as $Multiplo ) {
    // Se analiza el número actual mediante la única estructura (If) permitida para este ejercicio,
